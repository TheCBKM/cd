...
import { fadeInUp, icon3DVariants, button3DVariants, scaleIn } from '@/lib/animations';
...
function SubmitButton() {
  ...
  return (
    ...
    >
      <Button type="submit" disabled={pending} className="w-full bg-primary hover:bg-accent text-white transform-3d shadow-lg shadow-primary/20">
        {pending ? (
          <>
            <motion.div
              animate={{ rotate: 360 }}
...
export default function HealthSuggestionTool() {
  ...
  return (
    <section id="ai-tool" className="bg-white relative overflow-hidden py-16 md:py-20 lg:py-24">
        ...
        >
          ...
          >
            ...
            <p className="text-muted-foreground text-lg md:text-xl max-w-2xl mx-auto">
              Describe your health needs, and our AI will suggest the best The Chaitanya Group products for you.
            </p>
          </motion.div>
