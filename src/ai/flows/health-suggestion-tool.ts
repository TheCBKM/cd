...
const HealthSuggestionOutputSchema = z.object({
  products: z
    .string()
    .describe(
      'A list of product recommendations from Chaitanya Organics, tailored to the user health needs.'
    ),
});
...
const prompt = ai.definePrompt({
  ...
  prompt: `You are an AI assistant specialized in recommending products from Chaitanya Organics.
